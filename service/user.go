...
func CheckUser(username, password string) (bool, error) {
  ...
  //cant' check duplicates. will overwrite the existed data
  func AddUser(user *model.User) (bool, error) {
	...
	//totalhits: search if username exsit
	//>0 represents conflict with existed username
